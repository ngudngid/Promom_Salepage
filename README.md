...
| ชื่อไฟล์ | ใช้ในส่วน | สถานะ |
|---|---|---|
| `hero-product.png` | Hero — กล่องสินค้า 9 และ 9+ | ✅ ใส่แล้ว |
| `problem-screen.jpg` | ปัญหา — เด็ก + ลำไส้เรืองแสง | ✅ ใส่แล้ว |
| `product-lineup.png` | 4 กลไก — ไลน์สินค้า 3 ชิ้น | ✅ ใส่แล้ว |
| `dha-iron-brain.jpg` | DHA+ธาตุเหล็ก — เด็กอ่านหนังสือ+สมอง | ✅ ใส่แล้ว |
| `ltheanine-graph.png` | กราฟวิจัย L-Theanine (Alpha-wave) | ✅ ใส่แล้ว |
| `awards.jpg` | บูธ/รางวัล Promom | ✅ ใส่แล้ว |
| `collage.jpg` | คอลลาจรูปเด็ก/ครอบครัว | ✅ ใส่แล้ว |
| `offer-product.png` | ชุดสินค้าโปร 1 แถม 1 | ✅ ใส่แล้ว |
